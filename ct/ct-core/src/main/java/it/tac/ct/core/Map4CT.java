...
public class Map4CT implements Cloneable {
    ...
    public void insertF(int fNumberToAdd, int beginInsertPoint, int numberOfEToTouch) {
        ...
        int endInsertPoint = beginInsertPoint;
        ...
        //
        sequenceOfCoordinates.insertF(fNumberToAdd, beginInsertPoint, endInsertPoint);
        ...
        //
        faces.get(sequenceOfCoordinates.fNumberAtIndex(beginInsertPoint, -1) - 1).cardinality++;
    ...
    public static void printDetailedMap(Map4CT map) {
        ...
        // Print the header
        //
        // System.out.print("F" + (map.faces.size() + 1) + " *** " + map.key + " *** ");
        //
