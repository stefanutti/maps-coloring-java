 ...
 *         <p>
 *         It is used to construct the sequence of coordinates (Begin and End), as in the following example:
...
public class SequenceOfCoordinates implements Cloneable {
     ...
     *
     * @param index
     *            The index where to search
     * @param offset
     *            0 = face at index
     *           -1 = face at index as if the last face wasn't inserted
